...
class DevCommand extends Command {
  ...
  * run(context) {
    ...
    // 继承自common-bin模块的方法。来自child_process.fork。
    // 此方法和spawn,exec的区别要理清。
    // this.serverBin入口文件，是../start-cliuster。不过egg-bin,egg-script,还是手写入口，最后统一这个文件启动。
