...
function startServer(err) {
  ...
  if (options.sticky) {
    // 仅限本机访问，一般是nginx在前挡着。端口0，操作系统就会从动态端口号范围内搜索接下来可以使用的端口号
