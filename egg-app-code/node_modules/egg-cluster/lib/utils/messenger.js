 ...
 * ```
 */
// 这个messager是用来启动期间的通信。跟eggjs的多进程模型无关，那个在运行期间的通信在egg包里。
class Messenger {
   ...
   * @param {Object} data message body
   */
  // npm run dev和node xx.js 跑起来时，存在父进程的。npm start则无父进程。
  sendToParent(data) {
   ...
   * @param {Object} data message body
   */
  // 给worker进程发消息，检测其活着，从data中判断是否指定发给某个worker进程。
