...
class EggCore extends KoaApplication {
  ...
  constructor(options = {}) {
     ...
     * @since 1.0.0
     */
    // loader机制，agent和app的loader。
    // EGG_LOADER来自egg的application或者agent的EGG_LOADER，返回其loader。
    // AgentWorkerLoader或者AppWorkerLoader。
    const Loader = this[EGG_LOADER];
    assert(Loader, 'Symbol.for(\'egg#loader\') is required');
    // loader，在fork app进程和agent进程对的app_work.js的文件中。
    // new application的过程中，其原型的constructor中运行了loader。即初始化new运行了loader。
