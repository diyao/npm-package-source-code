...
module.exports = {
   ...
   * @since 1.0.0
   */
  // 通过name找到对应的额extend文件。如agent.js，把里面的属性赋给proto。
  loadExtend(name, proto) {
    ...
    for (let filepath of filepaths) {
      // app-agent-index.js 会被解出来。看下面，后续不再支持。
      ...
      // extend出来的是个对象，不是函数，不能传参。属性扩展官网推荐Symbol + Getter 的模式
      const ext = this.requireFile(filepath);
      // Symbol 作为属性名，不能被以往的一般方法给枚举，需要getOwnPropertySymbols
